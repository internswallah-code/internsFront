...
const App = () => {
  ...
  async function fetchUser() {
    try {
      let res = await axios.get(`${import.meta.env.VITE_BASE_URL}/me`, { withCredentials: true });
    ...
    try {
      let res = await axios.get(`${import.meta.env.VITE_BASE_URL}/employee-profile`, { withCredentials: true });
      if (res.data && res.data.fullName) {
